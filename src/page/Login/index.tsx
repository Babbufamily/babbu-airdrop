...
function Login() {
    ...
    const handleLogin = async (data: FieldValues) => {
        const result = await AirDropApi.verifyEmail(data);
    ...
    const handleGetCode = async (email: string) => {
        const result = await AirDropApi.login(email.trim().toLowerCase());
                    ...
                    <div className={cx("from--login")}>
                        ...
                        <div className={cx("row d-flex align-items-center")}>
                          ...
                          Code is invalid
                                            ...
                                            {timeLeft.seconds <= 0 && !timeLeft.seconds && ran && (
                                                <span className={cx("error--text")}>
                          Code is expired
                        </span>
                                            )}
                                    ...
                                    <div className={cx("list--icon--social")}>
                                        ...
                                        <img src="assets/svg/TWBLUE.svg" alt=""/>
